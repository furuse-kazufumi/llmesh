...
> **責務境界:** llmesh は **I/O・プロトコル・分析・LLM 経路** に専念。可視化と
> 対局・学習デモは姉妹リポ **[llove](https://github.com/furuse-kazufumi/llove)**
> に分離し、組み込み Linux / RTOS ターゲットでも `pip install llmesh-mcp` だけで
> 動くよう依存最小を維持しています。`llmesh dashboard` 1 発で TUI を呼べます。
